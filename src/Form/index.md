...
| labelCol           | `<label>`标签布局，同[<Grid.Col>](/components/grid)组件接收的参数相同，可以配置`span`和`offset`值，会覆盖全局的`labelCol`设置 | [ColProps](grid#col)                                                                                                                                                                                                                                                                | `{ span: 5, offset: 0 }`  | -                    |
...
| validateMessages   | 校验提示信息模板 [demo](/components/form#表单校验信息模板)                                                                    | Partial&lt;{[key in keyof ValidateMessagesTemplateType]: ValidateMessagesTemplateType[key] extends string? ValidateMessagesTemplateType[key] \| ((data, { label }) =&gt; any): Record&lt;keyof ValidateMessagesTemplateType[key], string \| ((data, { label }) =&gt; any)&gt;;}&gt; | `-`                       | 2.32.0               |
| validateTrigger    | 触发验证的时机。                                                                                                              | string \| string[]                                                                                                                                                                                                                                                                  | `onChange`                | 2.28.0               |
| wrapper            | 配置最外层标签，可以是 html 标签或是组件                                                                                      | [ComponentType](#componenttype)                                                                                                                                                                                                                                                     | `form`                    | -                    |
| wrapperCol         | 控件布局，同`labelCol`的设置方法一致，会覆盖全局的`wrapperCol`设置，[ColProps](/components/grid)                              | [ColProps](grid#col)                                                                                                                                                                                                                                                                | `{ span: 19, offset: 0 }` | -                    |
...
| labelCol          | `<label>`标签布局，同[<Grid.Col>](/components/grid)组件接收的参数相同，可以配置`span`和`offset`值，会覆盖全局的`labelCol`设置                                                                                                     | [ColProps](grid#col)                                                                                                                                                                     | `-`        | -                    |
...
| wrapperCol        | 控件布局，同`labelCol`的设置方法一致，会覆盖全局的`wrapperCol`设置，[ColProps](/components/grid)                                                                                                                                  | [ColProps](grid#col)                                                                                                                                                                     | `-`        | -                    |
