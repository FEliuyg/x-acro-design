...
| breakpoint       | 触发响应式布局的断点, 详见[响应式栅格](/components/Grid)                                                                            | [GridResponsiveBreakpoint](#gridresponsivebreakpoint)             | `-`     | -      |
| className        | 节点类名                                                                                                                            | string \| string[]                                                | `-`     | -      |
...
| resizeDirections | 可以用 ResizeBox 替换原生的 `aside` 标签，这个参数即 ResizeBox 的 `directions` 参数。详情请看 [ResizeBox](/components/resize-box)。 | string[]                                                          | `-`     | -      |
| style            | 节点样式                                                                                                                            | CSSProperties                                                     | `-`     | -      |
